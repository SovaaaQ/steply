...
LEVEL_THRESHOLDS = [
    ...
    },
    {
        ...
        "milestone": "Привычки держатся на подсказках и мягком возврате.",
    },
    {
        "level": 5,
        "min_xp": 1000,
        "title": "Питомец в отличной форме",
        "milestone": "Теперь главное не старт, а спокойная устойчивость.",
    },
]
...
ACHIEVEMENT_DEFINITIONS = [
    ...
    },
    {
        ...
        "description": "Собрать семь активных дней подряд без лишнего давления.",
        "metric": "longest_streak",
        "target": 7,
        "reward_xp": 70,
        "icon": "7",
...
QUEST_DEFINITIONS = [
    ...
    },
    {
        ...
        "next_step": "Используйте совет как подсказку, а не как оценку себя.",
        "sort_order": 30,
    },
    {
        "id": "daily_first_step",
